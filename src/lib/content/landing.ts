...
export const faqs = [
  {
    question: "Is GEMPREP a real interviewer replacement?",
    answer:
      "No. It is designed for repeated practice with peers, AI-assisted structure, and better feedback loops before real interviews.",
  },
  {
    question: "Will the first release include authentication or dashboards?",
    answer:
      "This phase is frontend foundation and landing page only. Auth, dashboards, rooms, and backend workflows are intentionally left for later phases.",
  },
  {
    question: "What interview types can the product support?",
    answer:
      "The UI architecture is prepared for coding, system design, behavioral, debugging, and role-specific technical screens.",
  },
  {
    question: "How does GEMPREP keep feedback fair?",
    answer:
